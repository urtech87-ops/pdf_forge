...
function pdfforge_seed_tools() {
	...
	$merge_pdf_content = '<p>Merge PDF lets you combine two or more PDF documents into a single file in seconds — without installing any software. Everything runs directly in your browser using your device\'s own processing power, so your files are never uploaded to a server and never leave your device.</p>
...
<p>Yes. Pages appear in the merged PDF in exactly the order shown in the file list. You can drag the handles to reorder files before clicking Merge, and the output will reflect that order precisely.</p>';
	...
	$starter_tools = [
		...
		[
			...
			'emoji'       => '✂️',
			'category'    => 'Edit PDF',
			'content'     => '<h1>Split PDF</h1><p>Coming soon — this tool is being built.</p>',
		],
		[
			'title'       => 'Compress PDF',
			'slug'        => 'compress-pdf',
			...
			'emoji'       => '🗜️',
			'category'    => 'Edit PDF',
			'content'     => '<h1>Compress PDF</h1><p>Coming soon — this tool is being built.</p>',
		],
	];
